        ...
        for name in files:
            try:
                with open(name) as f:
                    ...
                    result = re.sub('\'\'','INCOMPLETE', result)
                    result = re.sub('Both \',\' and \',\'','Both INCOMPLETE', result)
                    result = re.sub(' +',' ', result)
                    result = re.sub('Read the.*',' ''''','2019-02-16 00:00:00', 'Physics','Communication', 2,2);\n\n''', result)
